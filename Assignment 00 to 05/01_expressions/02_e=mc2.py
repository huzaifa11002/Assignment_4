...
# energy are interchangeable and are related by the above equation. You should ask the user 
# for mass (m) in kilograms and use a constant value for the speed of light -- C = 299792458 m/s.
...
def main():
    ...
    c = 299792458
    e = mass * c**2
    print("Mass-Energy Equivalence Formula")
    print(f"e = m * C^2...\n")
    print(f"m = {mass} kg")
    print(f"C = {c} m/s\n")
